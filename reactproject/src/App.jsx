...
const App = () => {
  ...
  {
    brandLogo: "https://upload.wikimedia.org/wikipedia/en/6/68/Oracle_logo.svg",
    companyName: "Oracle",
  ...
  return (
    <div className='parent'>
        {jobOpenings.map(function(elem,idx){
          return <div key={idx}>
              <Card key={idx} company={elem.companyName} post={elem.datePosted}  tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location} brandLogo={elem.brandLogo}/>
            </div>
        })}
    </div>
  )
